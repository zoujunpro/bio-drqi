...
public class AiProperties {
    ...
    public static class Risk {
        ...
        /**
         * in 条件最大值数量，避免模型生成超长条件拖慢数据库。
         */
        private Integer maxInValues = 100;

        /**
         * like 条件最大字符长度，避免超长模糊匹配。
         */
        private Integer maxLikeLength = 50;

        /**
         * last_days 最大允许天数。
         */
        private Integer maxLastDays = 366;

        /**
         * last_months 最大允许月数。
         */
        private Integer maxLastMonths = 24;
    }
    ...
    public static class RateLimit {
         ...
         * 单个客户端每分钟最大请求数。
         */
        private Integer requestsPerMinute = 30;

        /**
         * 全局同时处理的最大请求数。
         */
        private Integer maxConcurrentRequests = 20;
    }

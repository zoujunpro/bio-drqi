...
public class CerSampleApplyTb implements Serializable {
     ...
     * 取消后的取样数据信息
     */
    public String getCancelTaskSampleList() {
        return cancelTaskSampleList;
    }

    /**
     * 取消后的取样数据信息
     */
    public void setCancelTaskSampleList(String cancelTaskSampleList) {
        this.cancelTaskSampleList = cancelTaskSampleList;
    }
    ...
    public boolean equals(Object that) {
        ...
        CerSampleApplyTb other = (CerSampleApplyTb) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getCancelTaskSampleList() == null ? other.getCancelTaskSampleList() == null : this.getCancelTaskSampleList().equals(other.getCancelTaskSampleList()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getCancelTaskSampleList() == null) ? 0 : getCancelTaskSampleList().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", cancelTaskSampleList=").append(cancelTaskSampleList);

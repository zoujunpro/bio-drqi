...
public class PlantSampleTestTb implements Serializable {
    ...
    public boolean equals(Object that) {
        ...
        PlantSampleTestTb other = (PlantSampleTestTb) that;
        return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
            ...
            && (this.getTargetFlag() == null ? other.getTargetFlag() == null : this.getTargetFlag().equals(other.getTargetFlag()))
    ...
    public int hashCode() {
        ...
        result = prime * result + ((getTargetFlag() == null) ? 0 : getTargetFlag().hashCode());
    ...
    public String toString() {
        ...
        sb.append(", targetFlag=").append(targetFlag);

...
/**
 * 
 * @TableName tc_sample_test_bio_info_result_tb
 */
@TableName(value ="tc_sample_test_bio_info_result_tb")
public class TcSampleTestBioInfoResultTb implements Serializable {
    /**
     * 主键ID
     */
    ...
    public boolean equals(Object that) {
        ...
        TcSampleTestBioInfoResultTb other = (TcSampleTestBioInfoResultTb) that;
    ...
    public String toString() {
        ...
        sb.append(", matchFlag=").append(matchFlag);

...
public interface BioSampleTestTbMapper extends BaseMapper<BioSampleTestTb> {
    ...
    List<BioSampleTestTb> selectAllByVectorTaskCode(@Param("vectorTaskCode") String vectorTaskCode);

    List<BioSampleTestTb> selectAllByVectorTaskCodeAndSourceCode(@Param("vectorTaskCode") String vectorTaskCode, @Param("sourceCode") String sourceCode);
    ...
    int updateTestUserIdAndTestUserNameById(@Param("testUserId") Integer testUserId, @Param("testUserName") String testUserName, @Param("testTime") String testTime, @Param("id") Integer id);

...
public interface BmsOrderDetailTbMapper extends BaseMapper<BmsOrderDetailTb> {
    ...
    BmsOrderDetailTb selectOneByOrderDetailNum(@Param("orderDetailNum") String orderDetailNum);
    ...
    BigDecimal selectForOrderCount1(BmsOrderDetailTb bmsOrderDetailTb);
    ...
    List<BmsOrderDetailTb> selectForCountPurchaseAmountByProjectCode(BmsOrderDetailTb bmsOrderDetailTb);

    List<BmsOrderDetailTb> selectForCountReportAmountByProjectCode(BmsOrderDetailTb bmsOrderDetailTb);
}

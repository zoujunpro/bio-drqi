...
/**
* @author zou'jun
* @description 针对表【cer_species_conf(物种配置信息表)】的数据库操作Mapper
* @createDate 2023-11-20 10:16:57
* @Entity com.bio.cer.domain.CerSpeciesConf
*/
public interface CerSpeciesConfMapper extends BaseMapper<CerSpeciesConf> {

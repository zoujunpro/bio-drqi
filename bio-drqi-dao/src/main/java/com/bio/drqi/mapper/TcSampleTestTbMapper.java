...
public interface TcSampleTestTbMapper extends BaseMapper<TcSampleTestTb> {
    ...
    TcSampleTestTb selectOneByExperimentNumAndSampleCode(@Param("experimentNum") String experimentNum, @Param("sampleCode") String sampleCode);
    ...
    List<TcSampleTestTb> selectAllBySampleApplyNumAndSeedNumAndRegionNum(@Param("sampleApplyNum") String sampleApplyNum, @Param("seedNum") String seedNum, @Param("regionNum") String regionNum);

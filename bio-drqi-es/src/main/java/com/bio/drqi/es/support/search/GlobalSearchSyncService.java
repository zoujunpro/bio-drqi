...
public class GlobalSearchSyncService {
    ...
    private final Map<String, SearchDocumentBuilder> businessTableBuilderMap;
    private final Map<String, SearchDocumentBuilder> systemBusinessTableBuilderMap;
    ...
    public boolean upsert(String businessCode, String table, Map<String, Object> row) {
        SearchDocumentBuilder builder = resolveBuilder(businessCode, table);
        return upsert(builder, table, row);
    }

    public boolean upsert(String systemCode, String businessCode, String table, Map<String, Object> row) {
        SearchDocumentBuilder builder = resolveBuilder(systemCode, businessCode, table);
        return upsert(builder, table, row);
    }

    private boolean upsert(SearchDocumentBuilder builder, String table, Map<String, Object> row) {
        if (builder == null) {
    ...
    private SearchDocumentBuilder resolveBuilder(String businessCode, String table) {
        return businessTableBuilderMap.get(normalize(businessCode) + ":" + normalize(table));
    }

    private SearchDocumentBuilder resolveBuilder(String systemCode, String businessCode, String table) {
    ...
    private String builderKey(SearchDocumentBuilder builder) {
        return normalize(builder.table());
    }

    private String businessTableBuilderKey(SearchDocumentBuilder builder) {
        return normalize(builder.businessCode()) + ":" + normalize(builder.table());
    }

    private String systemBusinessTableBuilderKey(SearchDocumentBuilder builder) {
    ...
    private String resolveDocId(SearchDocumentBuilder builder, Object id) {
    ...
    private Map<String, Object> tableFilterQuery(SearchDocumentBuilder builder) {

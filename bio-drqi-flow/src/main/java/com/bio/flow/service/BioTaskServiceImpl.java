...
public class BioTaskServiceImpl implements BioTaskService {
    ...
    public PageInfo<BioTaskListPageRspDTO> listPage(BioTaskListPageReqDTO bioTaskListPageReqDTO, QueryTypeEnum queryTypeEnum) {
        ...
        if (QueryTypeEnum.TYPE_1 == queryTypeEnum) {
            bioTaskDtlTbList = bioTaskDtlTbMapper.selectSelectiveNoDraft(BioTaskDtlTb.builder().id(bioTaskListPageReqDTO.getId()).taskDesc(bioTaskListPageReqDTO.getTaskDesc()).applyDate(bioTaskListPageReqDTO.getApplyDate()).taskNum(bioTaskListPageReqDTO.getTaskNum()).taskTypeCode(bioTaskListPageReqDTO.getTaskTypeCode()).taskStatus(bioTaskListPageReqDTO.getTaskStatus()).applyUserId(bioTaskListPageReqDTO.getApplyUserId()).taskCategory(bioTaskListPageReqDTO.getTaskCategory()).build());
        } else if (QueryTypeEnum.TYPE_2 == queryTypeEnum) {
            bioTaskDtlTbList = bioTaskDtlTbMapper.selectForPendingApproval(String.valueOf(SecurityContextHolder.getUserId()), bioTaskListPageReqDTO.getId(), bioTaskListPageReqDTO.getTaskNum(), bioTaskListPageReqDTO.getTaskTypeCode(), bioTaskListPageReqDTO.getTaskCategory(), bioTaskListPageReqDTO.getApplyUserId(), bioTaskListPageReqDTO.getApplyDate(), bioTaskListPageReqDTO.getTaskDesc());
        } else if (QueryTypeEnum.TYPE_3 == queryTypeEnum) {
            bioTaskDtlTbList = bioTaskDtlTbMapper.selectSelective(BioTaskDtlTb.builder().id(bioTaskListPageReqDTO.getId()).taskDesc(bioTaskListPageReqDTO.getTaskDesc()).applyDate(bioTaskListPageReqDTO.getApplyDate()).taskNum(bioTaskListPageReqDTO.getTaskNum()).taskStatus(bioTaskListPageReqDTO.getTaskStatus()).taskTypeCode(bioTaskListPageReqDTO.getTaskTypeCode()).applyUserId(SecurityContextHolder.getUserId()).taskCategory(bioTaskListPageReqDTO.getTaskCategory()).build());
        } else if (QueryTypeEnum.TYPE_4 == queryTypeEnum) {
            bioTaskDtlTbList = bioTaskDtlTbMapper.selectForAlreadyApproval(String.valueOf(SecurityContextHolder.getUserId()), bioTaskListPageReqDTO.getId(), bioTaskListPageReqDTO.getTaskNum(), bioTaskListPageReqDTO.getTaskTypeCode(), bioTaskListPageReqDTO.getTaskCategory(), bioTaskListPageReqDTO.getTaskStatus(), bioTaskListPageReqDTO.getApplyUserId(), bioTaskListPageReqDTO.getApplyDate(), bioTaskListPageReqDTO.getTaskDesc());
        }

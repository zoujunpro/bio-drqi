        ...
        <#if contentData?exists >
            <#list contentData as content>
                ...
                <tr>
                    ...
                    <td class="td-title">粒 重(千克)：</td>
                    <td>${content.gw}</td>
                </tr>
                <tr>
                    <td class="td-title">性状纯度(%)：</td>
                    <td>${content.tpur}</td>
                    <td class="td-title">品种纯度(%)：</td>
                    <td>${content.gpur}</td>
                </tr>
                <tr>
                    <td class="td-title">转基因污染：</td>
                    <td>${content.gmi}</td>
                    <td class="td-title">净度(%)：</td>
                    <td>${content.vcla}</td>
                </tr>
                <tr>
                    <td class="td-title">芽率(%)：</td>
                    <td>${content.sgr}</td>
                    <td class="td-title">发芽势(%)：</td>
                    <td>${content.gene}</td>
                </tr>
            </#list>
        </#if>

...
import com.bio.drqi.manage.service.BioTaskService;
...
public class BioTaskController {
    ...
    public ResponseResult<PageInfo<ProjectTaskListPageRspDTO>> listPageMyApply(@RequestBody BioTaskListPageReqDTO bioTaskListPageReqDTO) {
    ...
    public ResponseResult<PageInfo<ProjectTaskListPageRspDTO>> listPageMyApprove(@RequestBody BioTaskListPageReqDTO bioTaskListPageReqDTO) {
    ...
    public ResponseResult<PageInfo<ProjectTaskListPageRspDTO>> listPageMyDeal(@RequestBody BioTaskListPageReqDTO bioTaskListPageReqDTO) {
    ...
    public ResponseResult<PageInfo<SeedInStoreDTO.ExecuteFormContent>> seedInData(@RequestBody @Validated SeedInDataReqDTO seedInDataReqDTO) {
        return ResponseResult.getSuccess(bioTaskService.seedInData(seedInDataReqDTO));
    }
    ...
    public ResponseResult<List<SeedTaskSeedNumRspDTO>> findAllSeedNum(@RequestParam @Validated Integer id) {
        List<SeedTaskSeedNumRspDTO> res = bioTaskService.findAllSeedNum(id);

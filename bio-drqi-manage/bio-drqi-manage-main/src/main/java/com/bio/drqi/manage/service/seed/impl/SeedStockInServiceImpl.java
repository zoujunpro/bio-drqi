...
public class SeedStockInServiceImpl implements SeedStockInService {
    ...
    public void store(SeedInStoreReqDTO seedInStoreReqDTO) {
        for (SeedInStoreReqDTO.Content content : seedInStoreReqDTO.getContentList()) {
            ...
            seedStockTb.setSpecies(executeFormContent.getSpeciesCode());
            ...
            seedStockTb.setSeedType(executeFormContent.getSeedType());
            ...
            seedStockTb.setProductionLocationName(executeFormContent.getProductionLocationName());

        ...
        <#if contentData?exists >
            <#list contentData as content>
                ...
                <tr>
                    ...
                    <td>${content.sourceType}</td>
                    <td class="td-title">代数：</td>
                    <td>${content.generation}</td>
                </tr>
                <tr>
                    <td class="td-title">种植编号：</td>
                    <td>${content.plantNum}</td>
                    <td class="td-title">上代种子编号：</td>
                    <td>${content.parentNum}</td>
                </tr>
                <tr>
                    <td class="td-title">作物：</td>
                    <td>${content.species}</td>
                    <td class="td-title">品种：</td>
                    <td>${content.breedCode}</td>
                </tr>
                <tr>
                    <td class="td-title">种子类型：</td>
                    <td>${content.seedType}</td>
                    <td class="td-title">生产地点：</td>
                    <td>${content.productionLocationName}</td>
                </tr>
                <tr>
                    <td class="td-title">收获日期：</td>
                    <td>${content.harvestTime}</td>
                    <td class="td-title">种子来源区域：</td>
                    <td>${content.sourceAddress}</td>
                </tr>
                <tr>
                    <td class="td-title">母本信息：</td>
                    <td>${content.matherInfo}</td>
                    <td class="td-title">父本信息：</td>
                    <td>${content.fartherInfo}</td>
                </tr>
                <tr>
                    <td class="td-title">收获方式：</td>
                    <td>${content.harvestType}</td>
                    <td class="td-title">数量：</td>
                    <td>${content.seedNumber}${content.unit}</td>
                </tr>
                <tr>
                    <td class="td-title">授粉方式：</td>
                    <td>${content.pollinationMethod}</td>
                    <td class="td-title">库存位置：</td>
                    <td>${content.stockLocationNum}</td>
                </tr>
            </#list>
        </#if>
        <tr>

...
public class SeedPlantService {
    ...
    public void seedInStockAddRefPlant(SeedStockTb seedStockTb) {
        ...
        if (SeedSourceEnum.CODE_4.code.equals(seedStockTb.getSourceType())) {
            TcHarvestSeedTb tcHarvestSeedTb = tcHarvestSeedTbMapper.selectOneByExperimentNumAndFRegionNumAndMRegionNumAndFSeedNumAndMSeedNumAndFSingleNumberAndMSingleNumber(seedStockTb.getExperimentNum(), seedStockTb.getFatherRegionNum(), seedStockTb.getMatherRegionNum(), seedStockTb.getFatherSeedNum(), seedStockTb.getMatherSeedNum(), seedStockTb.getFatherSingleNum(), seedStockTb.getMatherSingleNum());

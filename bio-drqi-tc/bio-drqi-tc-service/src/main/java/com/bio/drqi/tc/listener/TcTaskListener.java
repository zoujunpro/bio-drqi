package com.bio.drqi.tc.listener;
...
@Service
@Slf4j
public class TcTaskListener extends DefaultDuplicateCopyHandler implements FlowTaskListener<BioTaskDtlTb> {

    private final static Map<String, String> vieMap = new ConcurrentHashMap<>();

    @Value("${cer.properties.feiShuTcJumpUrl}")
    private String feiShuTcJumpUrl;
    ...
    static {
        vieMap.put("tc_experiment_task_apply", "fieldTest");

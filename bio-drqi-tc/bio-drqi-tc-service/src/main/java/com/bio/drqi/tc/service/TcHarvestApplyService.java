...
public interface TcHarvestApplyService {

    PageInfo<TcHarvestApplyListPageRspDTO> listPage(@RequestBody TcHarvestApplyListPageReqDTO tcHarvestApplyListPageReqDTO);
